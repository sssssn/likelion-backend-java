package com.likelion.project02.week7.day4.opgame.view;
...
public class MainGUI extends JFrame {
    ...
    private void loadCharImages() {
        String[][] imgResources = {
                {"normal", "/com/likelion/project02/character_men.gif"},
                {"success", "/com/likelion/project02/character_men_a.gif"},
                {"fail", "/com/likelion/project02/character_men_b.gif"}
        };
